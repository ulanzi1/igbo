export const PORTAL_ERRORS = {
  ...
  CONVERSATION_READ_ONLY: "PORTAL_ERRORS.CONVERSATION_READ_ONLY",
  SEEKER_CANNOT_INITIATE: "PORTAL_ERRORS.SEEKER_CANNOT_INITIATE",
  MESSAGING_APPLICATION_NOT_FOUND: "PORTAL_ERRORS.MESSAGING_APPLICATION_NOT_FOUND",
} as const;
