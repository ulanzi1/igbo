...
import { communityEvents, communityEventAttendees } from "../schema/community-events";
...
import type { CommunityEvent, NewCommunityEvent, EventStatus } from "../schema/community-events";

export type { CommunityEvent, NewCommunityEvent };
export type { AttendeeStatus } from "../schema/community-events";
