...
const IGBO_FIRST_NAMES_MALE = [
  "Chukwuemeka", "Obinna", "Ikechukwu", "Nnamdi", "Chibueze",
  "Chinedu", "Uchenna", "Emeka", "Obi", "Kelechi",
  "Nwachukwu", "Ugochukwu", "Chidi", "Ebuka", "Ifeanyichukwu",
  "Kenechukwu", "Chukwudi", "Obiora", "Azubuike", "Tochukwu",
  "Somadina", "Chijioke", "Okezie", "Nduka", "Ekene",
  "Uzochukwu", "Chukwuka", "Okwudili", "Ifeanyi", "Uche",
  "Okechukwu", "Arinze", "Uzoma", "Ogbonna", "Chukwubuikem",
  "Tobenna", "Chinonso", "Onyeka", "Jidenna", "Lotanna",
  "Dubem", "Chukwuebuka", "Ikenna", "Nnanna", "Osinachi",
  "Chikezie", "Ndubuisi", "Obichukwu", "Oluomachi", "Ikem",
];

const IGBO_FIRST_NAMES_FEMALE = [
  "Chioma", "Adaeze", "Ngozi", "Chiamaka", "Nneka",
  "Obiageli", "Adanna", "Chinyere", "Ifeoma", "Amaka",
  "Nnenna", "Ogechukwu", "Chinelo", "Chidimma", "Nkechi",
  "Adaobi", "Onyinyechi", "Eberechi", "Uchenna", "Somtochukwu",
  "Nneoma", "Oluchi", "Ugochi", "Kasiemobi", "Chidinma",
  "Akuchinyere", "Uzoamaka", "Nkemdirim", "Chikaodinaka", "Ego",
  "Mmesoma", "Sopuruchi", "Amarachi", "Tochi", "Ogechukwukama",
  "Kamsiyochukwu", "Ogechi", "Nneamaka", "Adaugo", "Ijemma",
  "Obianuju", "Munachiso", "Chinaza", "Udoka", "Zimuzo",
  "Nwamaka", "Ezinne", "Oluchukwu", "Oluebube", "Chika",
];

const IGBO_SURNAMES = [
  "Okafor", "Nwosu", "Eze", "Obi", "Nwankwo",
  "Onyekachi", "Okeke", "Nwachukwu", "Igwe", "Agu",
  "Chukwu", "Anyanwu", "Okonkwo", "Uzoma", "Ikechukwu",
  "Obinna", "Ibe", "Emeka", "Uche", "Nnaji",
  "Ekwueme", "Oguike", "Nwafor", "Chidera", "Onwuegbuzie",
  "Akpan", "Dimgba", "Agbai", "Ekeoma", "Ndubueze",
  "Ogbonnaya", "Ezeji", "Ukwu", "Mbachu", "Akujobi",
  "Iheanacho", "Nweke", "Umeh", "Okoli", "Opara",
  "Iwu", "Okoro", "Nnadi", "Odoemena", "Madueke",
  "Osuji", "Ejiofor", "Mbah", "Ekezie", "Nwoye",
  "Aneke", "Onuoha", "Ugwu", "Amadi", "Okwuosa",
  "Achebe", "Adichie", "Ohaeri", "Nwobodo", "Enwerem",
];
...
const SKILLS = [
  ...
  "Java", "SQL", "PostgreSQL", "MongoDB", "AWS",
  ...
  "Agriculture", "Agribusiness", "Food Technology",
  "Oil & Gas", "Renewable Energy", "Environmental Science",
  "Telecommunications", "Networking", "Cybersecurity",
  "Banking", "Insurance", "Microfinance",
];

const INDUSTRIES = [
  "Technology", "Finance", "Healthcare", "Education", "Oil & Gas",
  "Telecommunications", "Agriculture", "Manufacturing", "Retail",
  "Construction", "Transportation", "Media", "Consulting",
  "Real Estate", "Hospitality", "Legal Services", "NGO",
...
const JOB_TITLES = [
  ...
  "Sales Executive", "Account Manager", "Financial Analyst",
  "Accountant", "HR Manager", "Recruitment Specialist",
  "Civil Engineer", "Electrical Engineer", "Mechanical Engineer",
  "Teacher", "Lecturer", "Research Associate",
  "Nurse", "Pharmacist", "Doctor",
  "Lawyer", "Legal Advisor", "Compliance Officer",
  "Agricultural Officer", "Supply Chain Manager", "Logistics Coordinator",
  "Banking Officer", "Insurance Agent", "Consultant",
  "Content Writer", "Journalist", "Public Relations Officer",
  "Architect", "Quantity Surveyor", "Site Engineer",
];
...
const DESIRED_ROLES = [
  ...
  "Business Analyst", "Data Analyst", "UX Designer",
  "Marketing Manager", "Sales Manager", "Account Executive",
  "Financial Analyst", "Accountant", "HR Specialist",
  "Teacher", "Research Scientist", "Consultant",
];

const COMPANY_NAMES = [
  "Igbo Tech Solutions", "Nkemdirim Digital", "Odinaka Consulting",
  "ChiNexus Corp", "Anambra Systems", "Enugu Innovations",
  "Niger Bridge Technologies", "Obiora Group", "Ndi Igbo Ventures",
  "Okafor & Associates",
];
...
const CULTURAL_CONNECTIONS = [
  "Imo", "Anambra", "Enugu", "Abia", "Ebonyi", "Delta", "Rivers",
];

const INTERESTS = [
  "culture", "music", "food", "history", "language",
  "arts", "fashion", "diaspora", "technology", "entrepreneurship",
  "sports", "education", "community development",
];
...
const UNIVERSITIES = [
  ...
  "Federal University of Technology, Owerri", "Imo State University",
  "Enugu State University of Science and Technology",
  "Abia State University", "University of Lagos",
  "University of Ibadan", "Obafemi Awolowo University",
  "Covenant University", "University of Benin",
  "Ahmadu Bello University", "Federal University Oye-Ekiti",
...
const DEGREES = [
  ...
  "Bachelor of Technology", "Master of Engineering",
  "Bachelor of Education", "Doctor of Philosophy",
];

const FIELDS_OF_STUDY = [
  "Computer Science", "Electrical Engineering", "Mechanical Engineering",
  "Business Administration", "Economics", "Accounting",
  "Marketing", "Civil Engineering", "Medicine",
  "Law", "Education", "Agriculture",
  "Public Health", "Chemistry", "Physics",
  "Mathematics", "Information Technology", "Nursing",
];
...
async function seedSeekerProfiles(
  users: UserData[],
